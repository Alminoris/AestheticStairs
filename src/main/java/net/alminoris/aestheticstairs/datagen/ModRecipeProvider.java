...
public class ModRecipeProvider extends FabricRecipeProvider
{
    ...
    public void generate(Consumer<RecipeJsonProvider> recipeExporter)
    {
        for(String name : BlockSetsHelper.STONES)
        {
            ...
            ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.SMALL_STAIRS.get(name), 3)
                    .input('#', block)
                    .pattern("# ")
                    .pattern("##")
            ...
            ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.SMALL_HALFSTAIRS.get(name), 3)
                    .input('#', block)
                    .pattern("# ")
                    .pattern(" #")
                    .criterion(hasItem(block), conditionsFromItem(block))
        ...
        for(String name : BlockSetsHelper.WOODS)
        {
            ...
            Block block1 = Registries.BLOCK.get(Identifier.of("minecraft",name+"_planks"));
